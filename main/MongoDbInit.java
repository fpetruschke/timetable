 ...
 * class MongoDbInit
 * 
 * The class adds collections and the matching documents.
 * 
 * @author f.petruschke
 *
 */
public class MongoDbInit {
	 ...
	 * insertData
	 * 
	 * The method deletes any leftovers of collections for clean new collections.
	 * The new collections will be prefilled with data of the current timetable.
	 * 
	 * @throws Exception
	 */
	 ...
	 * collectionExists
	 * 
	 * Method checks if a collection with the given name already exists.
	 * 
	 * @param collectionName	String		Name of the collection to search for
	 * @return					boolean		True if collection with the given name was found
	 */
	public boolean collectionExists(String collectionName) {
		return MongoDbConnector.db.collectionExists(collectionName);
	}
